...
function OptionsModule(channel) {
    ...
    this.opts = {
        ...
        afk_timeout: 1000,        // Number of seconds before a user is automatically marked afk
        ...
        chat_antiflood: true,   // Throttle chat messages
        ...
        show_public: true,      // List the channel on the index page
