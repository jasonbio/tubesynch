...
PlaylistModule.prototype.packInfo = function (data, isAdmin) {
    if (this.current) {
        ...
        data.mediaid2       = this.current.media.id;
        data.mediatype2     = this.current.media.type;
        if (this.current.media.type === "yt") {
            data.mediaid    = "http://img.youtube.com/vi/"+this.current.media.id+"/0.jpg";
            data.mediatype  = "/img/youtube.png";
        } else if (this.current.media.type === "dm") {
            data.mediaid    = "http://www.dailymotion.com/thumbnail/video/"+this.current.media.id;
            data.mediatype  = "/img/dailymotion.png";
        } else if (this.current.media.type === "vi") {
            data.mediaid    = "/img/undefined.jpg";
            data.mediatype  = "/img/vimeo.png";
        } else if (this.current.media.type === "sc") {
            data.mediaid    = "/img/soundcloud.jpg";
            data.mediatype  = "/img/soundcloud.png";
        } else if (this.current.media.type === "li") {
            data.mediaid    = "http://thumbnail.api.livestream.com/thumbnail?name="+this.current.media.id;
            data.mediatype  = "/img/livestream.png";
        } else if (this.current.media.type === "tw") {
            initialid       = this.current.media.id;
            fixedid         = initialid.toLowerCase();
            data.mediaid    = "http://static-cdn.jtvnw.net/previews-ttv/live_user_"+fixedid+"-320x200.jpg";
            data.mediatype  = "/img/twitchtv.png";
        } else if (this.current.media.type === "jt") {
            initialid       = this.current.media.id;
            data.mediaid    = "http://thumbnails.vaughnsoft.com/1408838671/fetch/live/"+initialid+".png";
            data.mediatype  = "/img/vaughnlive.png";
        } else if (this.current.media.type === "su") {
            initialid       = this.current.media.id;
            data.mediaid    = "/img/streamupdef.png";
            data.mediatype  = "/img/streamup.png";
        } else if (this.current.media.type === "hb") {
            initialid       = this.current.media.id;
            data.mediaid    = "http://edge.sf.hitbox.tv/static/img/media/live/"+initialid+"_mid_000.jpg";
            data.mediatype  = "/img/hitbox.png";
        } else if (this.current.media.type === "us") {
            data.mediaid    = "/img/undefined.jpg";
            data.mediatype  = "/img/ustream.png";
        } else if (this.current.media.type === "jw") {
            data.mediaid    = "/img/undefined.jpg";
            data.mediatype  = "/img/rtmp.png";
        } else if (this.current.media.type === "im") {
            data.mediaid    = "/img/undefined.jpg";
            data.mediatype  = "/img/imgur.png";
        } else if (this.current.media.type === "cu") {
            data.mediaid    = "/img/undefined.jpg";
            data.mediatype  = "/img/custom.png";
        } else if (this.current.media.type === "gd") {
            data.mediaid    = "http://docs.google.com/vt?id="+this.current.media.id;
            data.mediatype  = "/img/googledocs.png";
        } else {
            data.mediaid    = "/img/undefined.jpg";
            data.mediatype  = "/img/undefined.jpg";
        }
...
PlaylistModule.prototype.handleQueue = function (user, data) {
     ...
     * and raw files
     */
    if (typeof data.title !== "string" || (data.type !== "cu" && data.type !== "fi" && data.type !== "jw")) {
        data.title = false;
    }
...
PlaylistModule.prototype._addItem = function (media, data, user, cb) {
    ...
    if (data.title && (media.type === "cu" || media.type === "fi" || media.type === "jw")) {
