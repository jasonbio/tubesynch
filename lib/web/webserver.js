...
function ipForRequest(req) {
    var ip = req.ip;
    if (ip === "127.0.0.1" || ip === "89.248.172.25" || ip === "89.248.172.25:80" || ip === "::1") {
...
module.exports = {
    ...
    init: function (app) {
        ...
        app.get("/tos", handleUserAgreement);
        app.get("/privacypolicy", handlePrivacyPolicy);
